...
public class MultiaddrCodec {
    ...
    public static final Instant UPDATED = Instant.parse("2026-07-06T21:31:03.612629174Z");

    public static final int CERTHASH_CODE = 0x1d2;
    ...
    public static final int DCCP_CODE = 0x21;
    ...
    public static final int DNS_CODE = 0x35;
    ...
    public static final int DNS4_CODE = 0x36;
    ...
    public static final int DNS6_CODE = 0x37;
    ...
    public static final int DNSADDR_CODE = 0x38;
    ...
    public static final int GARLIC32_CODE = 0x1bf;
    ...
    public static final int GARLIC64_CODE = 0x1be;
    ...
    public static final int HTTP_CODE = 0x1e0;
    ...
    public static final int HTTP_PATH_CODE = 0x1e1;
    ...
    public static final int HTTPS_CODE = 0x1bb;
    ...
    public static final int IP4_CODE = 0x4;
    ...
    public static final int IP6_CODE = 0x29;
    ...
    public static final int IP6ZONE_CODE = 0x2a;
    ...
    public static final int IPCIDR_CODE = 0x2b;
    ...
    public static final int NOISE_CODE = 0x1c6;
    ...
    public static final int ONION_CODE = 0x1bc;
    ...
    public static final int ONION3_CODE = 0x1bd;
    ...
    public static final int P2P_CODE = 0x1a5;
    ...
    public static final int P2P_CIRCUIT_CODE = 0x122;
    ...
    public static final int P2P_STARDUST_CODE = 0x115;
    ...
    public static final int P2P_WEBRTC_DIRECT_CODE = 0x114;
    ...
    public static final int P2P_WEBRTC_STAR_CODE = 0x113;
    ...
    public static final int P2P_WEBSOCKET_STAR_CODE = 0x1df;
    ...
    public static final int PLAINTEXTV2_CODE = 0x706c61;
    ...
    public static final int QUIC_CODE = 0x1cc;
    ...
    public static final int QUIC_V1_CODE = 0x1cd;
    ...
    public static final int SCION_CODE = 0xd02000;
    ...
    public static final int SCTP_CODE = 0x84;
    ...
    public static final int SHS_CODE = 0x1c8;
    ...
    public static final int SILVERPINE_CODE = 0x3f42;
    ...
    public static final int SNI_CODE = 0x1c1;
    ...
    public static final int TCP_CODE = 0x6;
    ...
    public static final int THREAD_CODE = 0x196;
    ...
    public static final int TLS_CODE = 0x1c0;
    ...
    public static final int UDP_CODE = 0x111;
    ...
    public static final int UDT_CODE = 0x12d;
    ...
    public static final int UNIX_CODE = 0x190;
    ...
    public static final int UTP_CODE = 0x12e;
    ...
    public static final int WEBRTC_CODE = 0x119;
    ...
    public static final int WEBRTC_DIRECT_CODE = 0x118;
    ...
    public static final int WEBTRANSPORT_CODE = 0x1d1;
    ...
    public static final int WS_CODE = 0x1dd;
    ...
    public static final int WSS_CODE = 0x1de;
