...
public class SerializationCodec {
    ...
    public static final Instant UPDATED = Instant.parse("2026-07-06T21:31:03.629484971Z");

    public static final int BENCODE_CODE = 0x63;
    ...
    public static final int CAR_CODE = 0x202;
    ...
    public static final int CAR_INDEX_SORTED_CODE = 0x400;
    ...
    public static final int CAR_MULTIHASH_INDEX_SORTED_CODE = 0x401;
    ...
    public static final int IPNS_RECORD_CODE = 0x300;
    ...
    public static final int MESSAGEPACK_CODE = 0x201;
    ...
    public static final int PROTOBUF_CODE = 0x50;
    ...
    public static final int PROVENANCE_LOG_CODE = 0x1208;
    ...
    public static final int PROVENANCE_LOG_ENTRY_CODE = 0x1209;
    ...
    public static final int PROVENANCE_LOG_SCRIPT_CODE = 0x120a;
    ...
    public static final int RLP_CODE = 0x60;
    ...
    public static final int SSZ_CODE = 0xb501;
    ...
    public static final int X509_CERTIFICATE_CODE = 0x210;
