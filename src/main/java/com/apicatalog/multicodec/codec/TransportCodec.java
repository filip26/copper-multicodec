...
public class TransportCodec {
    ...
    public static final Instant UPDATED = Instant.parse("2026-07-06T21:31:03.631977370Z");

    public static final int TRANSPORT_BITSWAP_CODE = 0x900;
    ...
    public static final int TRANSPORT_FILECOIN_PIECE_HTTP_CODE = 0x930;
    ...
    public static final int TRANSPORT_GRAPHSYNC_FILECOINV1_CODE = 0x910;
    ...
    public static final int TRANSPORT_IPFS_GATEWAY_HTTP_CODE = 0x920;
